...
audio_file_root = '/media/tshan@urmc-sh.rochester.edu/Elements/AMPLab/MusicABR/diverse_dataset/music_abr_diverse_beh/present_files/' # Present files root path
regressor_root = audio_file_root+'ANM_new/'
...
# Save regressor file
write_hdf5(regressor_root + '/music_x_in.hdf5',
...
# Save regressor file
write_hdf5(regressor_root + '/speech_x_in.hdf5',
